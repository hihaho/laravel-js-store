...
```
specs/
├── octane-store-isolation.md
├── blade-script-nonce.md
└── cleanup/
...
- Use `- [ ]` checkboxes. Each task must be concrete and verifiable — not "improve performance" but "reset the Store between Octane requests".
