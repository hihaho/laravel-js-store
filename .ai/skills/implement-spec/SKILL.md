...
argument-hint: [spec file path, e.g. specs/octane-store-isolation.md]
---
...
**Do NOT run PHPStan, Rector, or the full test suite between phases.** They are slow and only run at Final Verification (Step 3) after all phases are complete.
